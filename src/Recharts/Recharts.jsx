...
// const areaData1 = [
//   { month: "Jan", visitors: 12000, conversions: 6800 },
//   { month: "Feb", visitors: 15000, conversions: 7500 },
//   { month: "Mar", visitors: 20000, conversions: 12200 },
//   { month: "Apr", visitors: 18000, conversions: 1700 },
// ];
const areaData1 = [
...
const Recharts = () => {
  ...
  xKey="month"  
  areas={[
    { dataKey: "visitors", stroke: "#4F46E5", fill: "#A5B4FC", type: "monotone" },
    { dataKey: "conversions", stroke: "#EF4444", fill: "#de0000ff", type: "monotone" },
  ]}
/>
      </div>
  ...
  xKey="region"
  areas={[
    { dataKey: "organic", stroke: "#22C55E", fill: "#86EFAC", type: "monotone" },
    { dataKey: "paid", stroke: "#F97316", fill: "#FDBA74", type: "monotone" },
  ]}
/>
      </div>
...
/>
  ...
  <Linechart
    data={lineData1}
    xKey="city"  
    lines={[{ dataKey: "visitors", stroke: "#9333EA", type: "monotone" }]}
  />
</div>
...
<div className="chart-item">
  <Linechart
    data={lineData2}
    xKey="name"
    lines={[{ dataKey: "value", stroke: "#06B6D4", type: "monotone" }]}
  />
</div>
      ...
      <div className="chart-item">
        <PieChart
          data={pieData1}
          colors={COLORS1}
          pies={[{ dataKey: "employees", nameKey: "department", outerRadius: 100 }]}
        />
      </div>
